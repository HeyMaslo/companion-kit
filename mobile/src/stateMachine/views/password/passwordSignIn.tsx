...
export class PasswordSignInView extends PasswordBase {
    ...
    protected get title(): string { return 'Enter your password to confirm that it’s you'; }

    protected get useOptions(): boolean { return true; }
    ...
    protected submit = () => this.runLongOperation(() => this.viewModel.signInWithPassword());
}
