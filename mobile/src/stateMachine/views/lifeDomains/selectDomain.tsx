    ...
    renderContent() {
        ...
        return (
            <MasloPage
                ...
                <Container
                    style={[
                        { height: this._contentHeight, alignItems: 'center' },
                    ]}>
                    <Text style={[this.textStyles.h1, styles.title]}>
                        {selectedDomains.length == 2
                            ? `You have Selected the ${selectedDomains[0].name} & ${selectedDomains[1].name} Domains.`
                            : `You have Selected the ${mainDomain} Domain.`}{' '}
                    </Text>
                    <Text style={[this.textStyles.h1, styles.title]}>
                        {selectedDomains.length == 2
                            ? 'would you like to choose a third Domain?'
                            : 'would you like to choose an additional focus Domain?'}
                    </Text>
