...
export class DomainDetailsView extends ViewState {
    ...
    renderContent() {
        ...
        return (
            <MasloPage
                style={[this.baseStyles.page, { backgroundColor: '#E7E7F6' }]}
                onClose={() => this.cancel()}>
                <Container
                    style={[styles.container, { height: this._contentHeight }]}>
                    <View style={styles.header}>
                        <Text style={this.textStyles.h1}>
                            Why {mainName} is important to your quality of life
                        </Text>
                    </View>
                    <View style={styles.content}>
                        <Text
                            style={[this.textStyles.h3, { marginBottom: 10 }]}>
                            What to know:
                        </Text>
                        <ScrollView>
