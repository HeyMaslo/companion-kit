...
//         this._contentHeight = smallHeight ? this.persona.setupContainerHeightForceScroll({ rotation: 405 }) : this.persona.setupContainerHeight(minContentHeight, { rotation: 405 });
//     }
...
//                             this.textStyles.h1,
//                             styles.desc,
//                             { fontSize: this._questionFontSize(this.textStyles.h1.fontSize, this.layout.isSmallDevice ? 20 : 23), lineHeight: this._questionFontSize(this.textStyles.h1.lineHeight, 27) }]}
//                         >
//                             {viewModel.question}
//                         </Text>
//                         {viewModel.canRollQuestions && (
//                             <TouchableOpacity onPress={viewModel.rollQuestion} style={styles.refresh}>
//                                 <RefreshIcon height={20} width={20} />
//                                 <Text style={[this.textStyles.labelMedium, styles.refreshText]}>Next Prompt</Text>
//                             </TouchableOpacity>
//                         )}
//                     </View>
//                     <View style={styles.content}>
//                         <Text style={[this.textStyles.labelMedium, styles.heading]}>How do you want to share?</Text>
//                         <View style={styles.mainButtons}>
//                             <TouchableOpacity style={styles.button} onPress={this._goToText}>
//                                 <Images.textRecordIcon style={styles.icon} />
//                                 <Text style={[this.textStyles.labelMedium, styles.btnTitle]}>Write</Text>
//                             </TouchableOpacity>
//                             <View style={styles.separator} />
//                             <TouchableOpacity style={styles.button} onPress={this._goToRecord}>
//                                 <Images.recordIcon style={styles.icon} />
//                                 <Text style={[this.textStyles.labelMedium, styles.btnTitle]}>Record</Text>
//                             </TouchableOpacity>
//                             {PICTURE_CHECKIN_ENABLED && <>
//                                 <View style={styles.separator} />
//                                 <TouchableOpacity style={styles.button} onPress={this._goToPicture}>
//                                     <PhotoIcon style={styles.icon} />
//                                     <Text style={[this.textStyles.labelMedium, styles.btnTitle]}>Photo</Text>
//                                 </TouchableOpacity>
//                             </>}
//                         </View>
